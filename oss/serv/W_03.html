...
<link href="https://oss-auth.shop.wii.com/oss/oss/common/css/oss.css" rel="stylesheet" type="text/css" />
<link href="https://oss-auth.shop.wii.com/oss/oss/common/css/error.css" rel="stylesheet" type="text/css" />
...
<SCRIPT language="JavaScript" src="https://oss-auth.shop.wii.com/oss/oss/common/js//ec.js"></SCRIPT>
<SCRIPT language="JavaScript" src="https://oss-auth.shop.wii.com/oss/oss/common/js//error.js"></SCRIPT>
<SCRIPT language="JavaScript" src="https://oss-auth.shop.wii.com/oss/oss/common/js//buttons.js"></SCRIPT>
<SCRIPT language="JavaScript" src="https://oss-auth.shop.wii.com/oss/oss/common/js//images.js"></SCRIPT>
<SCRIPT language="JavaScript" src="https://oss-auth.shop.wii.com/oss/oss/common/js//sound.js"></SCRIPT>
<SCRIPT language="JavaScript" src="https://oss-auth.shop.wii.com/oss/oss/common/js//shop.js"></SCRIPT>
<SCRIPT language="JavaScript" src="https://oss-auth.shop.wii.com/oss/oss/common/js//oss.js"></SCRIPT>
...
body {
    ...
    background-image: url(/oss/oss/common/images//back/A_03_back2.gif);
...
function initPage()
{
    ...
    MM_preloadImages('/oss/oss/common/images//banner/banner01L_b.gif');

    MM_preloadImages('/oss/oss/common/images//banner/banner01R_b.gif');
    
    hideElement("WW_on_text");
    hideElement("WW_on_banner");
    hideElement("WW_on_spacer");
    showElement("WW_off");
