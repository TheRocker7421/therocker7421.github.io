...
<div id="goodsdetails">
  <div id="title02">
    ...
    <div align="left"><span style="overflow:hidden" class="headerWhiteM"><script language="JavaScript">document.write('[NEW]Reminder: Wii Shop Opens Apr. 30, 2021'.replace('[NEW]', '<img src="/oss/oss/common/images//banner/NEW_en.gif"> '));</script></span></div>
    </div>
  </div>
  <img src="/oss/oss/common/images//banner/box.gif" width="540" height="272" />
  <div id="free">
    <iframe src="W_02_1.jsp?p=1&country=US&serial=&language=en&region=2&age=" frameborder="0" style="border:solid 1px #FFFFFF;" scrolling="Auto" width="530" height="240"></iframe>
  </div>
</div>
</body>
</html>
