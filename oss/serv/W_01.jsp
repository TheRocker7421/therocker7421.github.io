...
<title>Welcome to the Wii Shop Channel</title>
<style type="text/css">
  /* W_01: Welcome Page */
.invisible {
	visibility: hidden;
...
function change_Header_titlelistName0()
{
    ...
    titleElem.innerHTML="<span class='style1'>Wii Shop Channel</span><span class='style2'>Recommended Titles</span>";
...
<div id="info01n" align="center">
        <script language="JavaScript">if ('[NEW]Reminder: Wii Shop Opens Apr. 30, 2021'.indexOf('[NEW]', 0) != -1) {document.write('<img src="/oss/oss/common/images//banner/NEW_en.gif"> ');};</script>
      </div>
      <div id="info01">
        <div nowrap align="left" class="txt_info">
          <script language="JavaScript">document.write('[NEW]Reminder: Wii Shop Opens Apr. 30, 2021'.replace('[NEW]', ''));</script>
        </div>
      </div>
      <div id="infoShadow01"><img src="/oss/oss/common/images//spacer.gif" border="0" name="info01s" /></div>
      <div id="infoSpacer01"><a href="/oss/serv/W_02.jsp?p=1"><img src="/oss/oss/common/images//spacer.gif" width="514" height="25" border="0" onMouseDown="MM_swapImage('info01s','','/oss/oss/common/images//banner/GifA_News_Press.png',1);" onMouseUp="MM_swapImage('info01s','','/oss/oss/common/images//banner/GifA_News_Over.png',1)" onClick="snd.playSE(cSE_Decide);" onmouseover="snd.playSE( cSE_Forcus ); MM_swapImage('info01s','','/oss/oss/common/images//banner/GifA_News_Over.png',1);move_fleeze_cursor();" onMouseOut="MM_swapImage('info01s','','/oss/oss/common/images//banner/GifA_News_noAction.png',1);" /></a></div>
